...
public class SignInActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		fragmentTabHost.addTab(
				fragmentTabHost.newTabSpec(LOGIN_TAB_TAG).setIndicator(getString(R.string.login_tab_label)),
				LogInFragment.class, null);
		fragmentTabHost.addTab(
				fragmentTabHost.newTabSpec(SIGNUP_TAB_TAG).setIndicator(getString(R.string.signup_tab_label)),
